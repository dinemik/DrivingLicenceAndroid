    ...
    public static class GetStatisticsService
    {
        ...
        private static async Task<IEnumerable<ITicketAnsweredStatistic>> GetByDayStatistic()
        {
            return await Task.Run(async () => {
                ...
                {
                    Correct = ticketLst.Where(ticket => ticket.Answers.First(ans => ans.Ans == ticket.UserAnswer).Correct).Count(),
                    Incorrect = ticketLst.Where(ticket => !ticket.Answers.First(ans => ans.Ans == ticket.UserAnswer).Correct).Count(),
